...
{
    public class CategoriaMapper : IEntityTypeConfiguration<CategoriaModel>
    {
        public void Configure(EntityTypeBuilder<CategoriaModel> builder)
        {
            ...
            // Relacionamento com Usuario - CASCADE para excluir categorias quando usuário for excluído
